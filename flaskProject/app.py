...
""" This exists because I couldn't work out how to import the wikipedia base as a flask project
...
@app.route('/fahrenheit_to_celcius/<temperature>')
def fahrenheit_to_celcius(temperature):
    celsius = 5.0 / 9 * (float(temperature) - 32)
